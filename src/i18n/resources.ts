  ...
  en: {
    translation: {
      ...
      profilePage: {
        ...
        loginRequiredDescription: "Please try again after anonymous sign-in.",
        title: "Profile",
        noName: "No name",
  ...
  ko: {
    translation: {
      ...
      profilePage: {
        ...
        loginRequiredDescription: "익명 로그인 후 다시 시도해주세요.",
        title: "프로필",
        noName: "이름 없음",
        authStatus: "인증 상태",
        signedIn: "로그인됨",
  ...
  ja: {
    translation: {
      ...
      profilePage: {
        ...
        loginRequiredDescription: "匿名ログイン後に再試行してください。",
        title: "プロフィール",
        noName: "名前なし",
        authStatus: "認証状態",
        signedIn: "ログイン済み",
