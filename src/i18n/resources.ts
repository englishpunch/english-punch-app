...
const enTranslation = {
  ...
  activity: {
    ...
    filtersLabel: "Filter activity types",
    noMatchingActivities: "No matching activity. Try another filter or day.",
    columns: {
      time: "Time",
      event: "Activity",
      question: "Question",
  ...
  bagDetail: {
    ...
    searchNotice:
      "Search results are ranked by answer relevance. Clear the search to sort by Next review or Created.",
...
const jaTranslation = {
  ...
  activity: {
    ...
    filtersLabel: "アクティビティの種類で絞り込み",
    noMatchingActivities:
      "該当するアクティビティはありません。別のフィルターや日付を選んでください。",
    columns: {
      time: "時刻",
      event: "アクティビティ",
      question: "質問",
  ...
  bagDetail: {
    ...
    searchNotice:
      "検索結果は答えとの関連度順です。次回の復習または作成日で並べ替えるには検索をクリアしてください。",
